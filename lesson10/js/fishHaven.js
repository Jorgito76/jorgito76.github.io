...
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=f733a7a677f906c085116effb07477c2&units=imperial';
fetch(forecastURL)
    .then((response) => response.json())
    .then((forecastObject) => {
    ...
    const apiURL2 =
  "//api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=300a54035f682f83ebf3aa7d44d398ba";
